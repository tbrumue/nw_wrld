...
export const TerminalProgressBar = ({
  ...
  return (
    <div className="flex items-center gap-2 font-mono">
      {label && (
        <span className="text-[11px] text-neutral-300 min-w-[80px]">{label}:</span>
      )}
      <div
        className="h-3 bg-[#101010] border border-neutral-800 relative"
        style={{ width: `${width}px` }}
      >
        <div className="h-full bg-neutral-300" style={{ width: `${filledWidth}px` }} />
      </div>
